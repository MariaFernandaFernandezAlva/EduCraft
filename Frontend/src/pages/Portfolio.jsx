      ...
      <section className="bg-linear-to-br from-blue-900 to-teal-600 text-white py-20 md:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-2xl mx-auto">
            Descubre proyectos académicos de alta calidad realizados para
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="text-sm text-gray-600">
                ...
                <span className="font-bold">
                  {Math.min(endIndex, portfolioData.length)}
                </span>{" "}
                de <span className="font-bold">{portfolioData.length}</span>{" "}
                proyectos
              </p>
      ...
      <section className="bg-gray-50 py-20 md:py-32">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            No permitas que la complejidad del proyecto te bloquee. Nuestro
            equipo está listo para transformar tus ideas en realidades
            académicas excepcionales.
          </p>
